...
def write_learners():
    ...
    # Add more learners objects
    learner_sarah = Learner(first_name='Sarah', last_name='Johnson', dob=date(1995, 9, 5),
                        occupation='student',
                        social_link='https://www.linkedin.com/sarah/')
    learner_sarah.save()
    learner_michael = Learner(first_name='Michael', last_name='Brown', dob=date(1990, 12, 10),
                          occupation='data_analyst',
                          social_link='https://www.linkedin.com/michael/')
    learner_michael.save()
    learner_emily = Learner(first_name='Emily', last_name='Davis', dob=date(1988, 4, 20),
                        occupation='web_developer',
                        social_link='https://www.facebook.com/emily/')
    learner_emily.save()

    print("Additional Learner objects saved... ")
